(ns algorithm-data-structure.algorithms.graph.breadth-first-search-test
  (:require [algorithm-data-structure.algorithms.graph.breadth-first-search :as bfs]
...
(deftest allow-traversal-fn-test
  (let [allow-traversal (bfs/allow-traversal-fn)]
    (is (= true
